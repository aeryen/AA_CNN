    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            cnn = TextCNN(
                ...
                num_classes=dater.num_of_classes,  # Number of classification classes
            ...
            pred_ratio_summary = []
            for i in range(dater.num_of_classes):
...
for f_size in [100]:
    for l2 in [0.1]:  # [0.1, 0.3, 0.6, 0.9]:
        for drop in [0.75]:
            ...
            for train_step in bold_step2:  # [1500, 1750, 2000, 2250, 2500]:
